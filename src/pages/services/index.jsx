...
const Services = () => {
  ...
  const [ourServicesList, setOurServicesList] = useState([
    ...
    },
    {
      ...
      img: img2,
      textNumber1:
        "1. Fast and Immediate Results: In the competitive landscape of mortgage brokering, real estate, and legal services, time is of the essence. Our PPC Marketing services provide you with fast and immediate results. By strategically placing your ads on search engines and relevant platforms, we can drive" +
        " targeted traffic to your website or landing pages, generating leads and conversions quickly.",
      textNumber2:
        "2. High-Converting Client Targeting: We understand that reaching the right audience is essential for success. Through our PPC campaigns, we will implement advanced targeting techniques to ensure your ads are seen by individuals actively seeking mortgage services, real estate assistance, or legal counsel. By focusing on high-converting client targeting, we maximize " +
        "your chances of connecting with potential clients who are ready to take action",
      textNumber3:
        "3. Enhanced Search Engine Visibility: Our PPC Marketing strategies go hand in hand with improving your search engine visibility. By carefully selecting keywords, optimizing ad copy, and leveraging best practices, we will enhance your presence on search engine results pages (SERPs). This increased visibility not only boosts your brand's " +
        "credibility but also positions you ahead of your competition, driving more qualified leads to your website.",
      textNumber4:
        "4. Customized Ad Campaigns: We recognize that each business has unique goals and target audiences. Our team will work closely with you to understand your specific requirements and develop customized ad campaigns that align with your brand and objectives. Whether you need ads for mortgage services, real estate listings, or legal services, " +
        "we will create compelling and persuasive ad copy that entices potential clients to click and convert.",
      textNumber5:
        "5. Continuous Monitoring and Optimization: PPC campaigns require constant monitoring and optimization to deliver optimal results. Our team will closely monitor your campaigns, analyze performance metrics, and make data-driven adjustments to ensure maximum return on investment (ROI). We will refine your targeting parameters, optimize your ad spend, and " +
...

    {
      ...
      mobileText:
        "At MMedia Development Group, we offer Strategic Social Media Marketing (SMM) services specifically designed for mortgage brokers, real estate agents, and real estate lawyers. Our expertise in leveraging social media platforms empowers you to build brand awareness, forge meaningful connections" +
        " with your clients, and drive business growth in the digital age.",

      img: img1,
      textNumber1:
        "1. Targeted Brand Awareness: We understand the importance of establishing a strong brand presence in the highly competitive mortgage brokering, real estate agent, and real estate lawyer industries. Through our Social Media Marketing services, we will create targeted campaigns that increase your brand visibility among your ideal target audience. We will craft compelling content that highlights your expertise," +
      ...
      textNumber3:
        "3. Meaningful Client Connections: Social media platforms offer invaluable opportunities to connect with your clients on a personal level. We will assist you in fostering meaningful relationships by engaging in conversations, responding to inquiries, and addressing client concerns promptly. Through strategic community management, we will build trust and loyalty, " +
      ...
      textNumber5:
        "5. Analytics and Performance Tracking: We believe in data-driven strategies. Our team will monitor and analyze the performance of your social media campaigns, providing you with valuable insights into audience engagement, campaign reach, and conversion rates. With these metrics in hand, we can continuously refine your strategy, optimize your campaigns, and deliver measurable results that align with your business goals.",
      state: "",
  ...
  const [whyChooseList, setWhyChooseList] = useState([
    ...
    },
    {
      ...
      text:
        "2. Targeted Strategies: We understand that effective marketing is all about reaching the right audience at the right time. Our team takes the time to understand your business goals, target audience, and local market dynamics. Armed with this information, we develop customized marketing strategies that resonate with your potential clients, driving qualified leads to your business. Whether you are looking to attract first-time homebuyers, expand your referral network," +
    ...
    },
    {
      ...
      text:
        "4. Data-Driven Approach: We believe that data holds the key to unlocking your business's true potential. Our team utilizes advanced analytics tools to track and measure the performance of your campaigns. By analyzing key metrics and consumer behavior, we gain valuable insights into what's working and what needs improvement. This data-driven approach enables us to continuously optimize your marketing efforts, " +
    ...
    },
    {
      ...
      text:
        "5. Transparent Communication: We value open and honest communication with our clients. Throughout our partnership, we keep you informed about the progress of your campaigns, providing regular updates and detailed reports. We believe that collaboration is the key to success, so we encourage your feedback and input every step of the way. Our dedicated team is readily available to address any questions or concerns" +
  ...
  return (
    <>
        ...
        <div style={{ backgroundImage: `url(${business})` }} className="our_services_image G-image">
          ...
          <div className="G-container">
            <div className="our_services_title">
              <h3>Our Services</h3>
              <p>
                Together, we will dive deeper into your goals, challenges, and opportunities. Our team will develop a
                customized digital marketing strategy that aligns with your vision and helps you achieve sustainable
                growth. Let's embark on this exciting journey and take your business to new heights.
              </p>
            </div>
      ...
      <MyModal onClose={handleClick} active={openModal} item={servicesItem} />
    </>
  );
};
